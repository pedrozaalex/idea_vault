...
import {json, Links, LiveReload, LoaderFunction, Meta, Outlet, Scripts, ScrollRestoration, useLoaderData,} from 'remix';
...
export default function App() {
  ...
  return (
    ...
    <Navbar/>
    <main className="grow flex flex-row space-x-4 overflow-hidden">
      <Outlet/>
    </main>
    <ScrollRestoration/>
    <Scripts/>
